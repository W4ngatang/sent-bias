...
python sentbias/main.py -m ulmfit --use_cpu --log_file log$suffix --results_path results.tsv$suffix --ulmfit_dir /export/b02/cmay14/sentbias/ulmfit --layer_combine_method last
python sentbias/main.py -m ulmfit --use_cpu --log_file log$suffix --results_path results.tsv$suffix --ulmfit_dir /export/b02/cmay14/sentbias/ulmfit --layer_combine_method concat --time_combine_method mean
python sentbias/main.py -m ulmfit --use_cpu --log_file log$suffix --results_path results.tsv$suffix --ulmfit_dir /export/b02/cmay14/sentbias/ulmfit --layer_combine_method last --time_combine_method mean
