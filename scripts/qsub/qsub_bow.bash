...
python sentbias/main.py --parametric -m bow --use_cpu --log_file log$suffix --results_path results.tsv$suffix --glove_path /export/b02/cmay14/sentbias/glove.840B.300d.txt
