...
python sentbias/main.py -m gensen --use_cpu --log_file log$suffix --results_path results.tsv$suffix --glove_h5_path $SENTBIAS_ROOT/glove.840B.300d.h5 --gensen_dir $SENTBIAS_ROOT/gensen --gensen_version nli_large_bothskip
