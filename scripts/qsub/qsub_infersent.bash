...
python sentbias/main.py -m infersent --use_cpu --log_file log$suffix --results_path results.tsv$suffix --glove_path $SENTBIAS_ROOT/glove.840B.300d.txt --infersent_dir $SENTBIAS_ROOT/infersent
